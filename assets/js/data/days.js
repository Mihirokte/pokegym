...
export const DAYS = [
  {
    ...
    focus: 'Upper Push',
    tag: 'STRENGTH',
    color: '#EF4444',       // red — crimson fire
    accent: '#FCA5A5',
    team: 'fighter',        // Machop line
  ...
  },
  {
    ...
    accent: '#6EE7B7',
    team: 'grappler',       // Tyrogue → Hitmonchan
  ...
  },
  {
    ...
    tag: 'STRENGTH',
    color: '#8B5CF6',       // violet — aura
    accent: '#C4B5FD',
    team: 'aura',           // Riolu → Lucario
  ...
  },
  {
    ...
    focus: 'Full Body + Abs',
    tag: 'HYBRID',
    color: '#F97316',       // orange — dragon fire
    accent: '#FDBA74',
    team: 'dragon',         // Dratini → Dragonair → Dragonite
