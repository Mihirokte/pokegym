...
//
// Organized by muscle umbrella, not by day — the Push/Pull/Legs split in
// days.js picks one compound + complementary accessories per muscle group.
// Exercises not used in the default split remain here as library entries
// and Pokéball wild-pool candidates.
//
...
//   - Jeff Nippard's Pure Hypertrophy / Push-Pull-Legs programs
...
export const EXERCISES = Object.fromEntries([
  ...
  // ─── Core / Abs (sprinkled across PPL days) ─────────────────────────────
  ...
  // ─── Conditioning / hybrid (library + wild pool) ────────────────────────
  // Not in any default PPL day — pull these in for cardio sessions or via Pokéball.
  ...
  // ─── Wild-pool extras (Pokéball RNG) ────────────────────────────────────
  // These aren't in any day's default routine but get pulled by the Pokéball.
