...
export const EXERCISES = Object.fromEntries([
  ...
  // ─── Monday — Upper Push ────────────────────────────────────────────────
  E('push-bench-bb',     { name: 'Barbell Bench Press',    section: 'workout', muscle: 'chest',      equipment: 'barbell',    type: 'strength',   defaultSets: 4, defaultReps: '8-10',  isTime: false, trackLoad: true,  cue: 'Tuck elbows ~60°. Bar to lower chest. Leg drive.', wild: false }),
  E('push-incline-db',   { name: 'Incline Dumbbell Press', section: 'workout', muscle: 'upper chest',equipment: 'dumbbell',   type: 'strength',   defaultSets: 4, defaultReps: '10-12', isTime: false, trackLoad: true,  cue: '30° bench. Elbows under wrists. Full stretch.', wild: false }),
  ...
  E('push-lateral-db',   { name: 'Dumbbell Lateral Raise', section: 'workout', muscle: 'side delt',  equipment: 'dumbbell',   type: 'strength',   defaultSets: 4, defaultReps: '12-15', isTime: false, trackLoad: true,  cue: 'Lead with elbow. Stop at shoulder height.',   wild: true, pokemon: 'hitmonchan' }),
  ...
  // ─── Tuesday — Lower ────────────────────────────────────────────────────
  E('lo-squat-bb',       { name: 'Barbell Back Squat',     section: 'workout', muscle: 'quads',      equipment: 'barbell',    type: 'strength',   defaultSets: 4, defaultReps: '6-8',   isTime: false, trackLoad: true,  cue: 'Break at hips and knees together. Chest proud.',wild: false }),
  E('lo-rdl-bb',         { name: 'Romanian Deadlift',      section: 'workout', muscle: 'hamstrings', equipment: 'barbell',    type: 'strength',   defaultSets: 4, defaultReps: '8-10',  isTime: false, trackLoad: true,  cue: 'Hinge at hips, bar scrapes thighs. Flat back.',  wild: false }),
  ...
  E('lo-calf-standing',  { name: 'Standing Calf Raise',    section: 'workout', muscle: 'calves',     equipment: 'machine',    type: 'strength',   defaultSets: 4, defaultReps: '12-15', isTime: false, trackLoad: true,  cue: 'Full stretch at bottom, pause 1s at top.',       wild: false }),
  ...
  E('cond-thruster',     { name: 'Dumbbell Thruster',      section: 'workout', muscle: 'full body',  equipment: 'dumbbell',   type: 'strength',   defaultSets: 4, defaultReps: '10',     isTime: false, trackLoad: true,  cue: 'Squat → drive → press in one motion.',          wild: false }),
  E('cond-kb-swing',     { name: 'Kettlebell Swing',       section: 'workout', muscle: 'posterior',  equipment: 'kettlebell', type: 'strength',   defaultSets: 4, defaultReps: '15',     isTime: false, trackLoad: true,  cue: 'Hip snap — not a squat. Float the bell.',       wild: true, pokemon: 'cubone' }),
  E('cond-box-jump',     { name: 'Box Jump',               section: 'workout', muscle: 'quads',      equipment: 'box',        type: 'strength',   defaultSets: 4, defaultReps: '10',     isTime: false, trackLoad: false, cue: 'Land soft and athletic. Step down — never jump.',wild: true, pokemon: 'scyther' }),
  E('cond-battle-rope',  { name: 'Battle Ropes',           section: 'workout', muscle: 'shoulder',   equipment: 'ropes',      type: 'cardio',     defaultSets: 4, defaultReps: '30s',    isTime: true,  trackLoad: false, cue: 'Stay athletic. Alternate waves, then slams.',    wild: true, pokemon: 'seviper' }),
  E('cond-sled-push',    { name: 'Sled Push',              section: 'workout', muscle: 'quads',      equipment: 'sled',       type: 'strength',   defaultSets: 4, defaultReps: '40m',    isTime: false, trackLoad: true,  cue: 'Low body angle. Drive through mid-foot.',        wild: true, pokemon: 'tauros' }),
  ...
  // ─── Thursday — Upper Pull ──────────────────────────────────────────────
  E('pull-latpull',      { name: 'Lat Pulldown',           section: 'workout', muscle: 'back',       equipment: 'cable',      type: 'strength',   defaultSets: 4, defaultReps: '10-12', isTime: false, trackLoad: true,  cue: 'Elbows drive down-and-back. Chest to bar.',     wild: false }),
  E('pull-row-bb',       { name: 'Barbell Row',            section: 'workout', muscle: 'back',       equipment: 'barbell',    type: 'strength',   defaultSets: 4, defaultReps: '8-10',  isTime: false, trackLoad: true,  cue: 'Hinge to 45°. Pull to belly, not chest.',        wild: false }),
  ...
  E('glu-hip-thrust',    { name: 'Barbell Hip Thrust',     section: 'workout', muscle: 'glutes',     equipment: 'barbell',    type: 'strength',   defaultSets: 4, defaultReps: '8-10',  isTime: false, trackLoad: true,  cue: 'Ribs down. Lock out glutes at top. Pause 1s.',   wild: false }),
  ...
  E('glu-leg-press-deep',{ name: 'Deep Leg Press',         section: 'workout', muscle: 'glutes',     equipment: 'machine',    type: 'strength',   defaultSets: 4, defaultReps: '12',     isTime: false, trackLoad: true,  cue: 'Feet high on platform. Go as deep as back allows.',wild: false }),
  ...
  E('fb-clean-press',    { name: 'DB Clean and Press',     section: 'workout', muscle: 'full body',  equipment: 'dumbbell',   type: 'strength',   defaultSets: 4, defaultReps: '8',      isTime: false, trackLoad: true,  cue: 'One fluid motion — floor to overhead.',          wild: false }),
